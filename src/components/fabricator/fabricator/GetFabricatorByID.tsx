    ...
    <div className="bg-white dark:bg-slate-900 p-6 md:p-8 rounded-3xl shadow-soft text-sm border border-gray-100 dark:border-slate-800">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4 mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[10px]  text-gray-400 dark:text-slate-500 uppercase tracking-widest">Global Operations Partner</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <span
            className={`px-4 py-1.5 rounded-xl text-xs  uppercase tracking-widest ${fabricator.isDeleted
      ...
      <div className="flex flex-wrap gap-x-8 gap-y-2 mb-8 border-b border-gray-100 dark:border-slate-800">
        <button
          ...
          className={`pb-4 px-1 text-xs  uppercase tracking-widest transition-all relative ${activeTab === "dashboard"
        ...
        <button
          ...
          className={`pb-4 px-1 text-xs  uppercase tracking-widest transition-all relative ${activeTab === "details"
            ? "text-green-600 dark:text-green-400"
            : "text-gray-400 hover:text-gray-600 dark:text-slate-500 dark:hover:text-slate-300"
            }`}
        >
              ...
              <div className="mt-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {(fabricator.files as { id: string; originalName: string }[]).map((file) => (
                    ...
                    >
                      <span className=" text-gray-700 dark:text-slate-300 truncate mr-4">{file.originalName}</span>
                      <button
