...
interface EditCDProps {
  designerData: ConnectionDesigner; // Use FabricatorWithFiles for clarity
  onClose: () => void;
  onSuccess?: () => void;
}
...
const EditConnectionDesigner = ({
  ...
  const onSubmit = async (data: CDFormData) => {
    try {
      setSubmitting(true);
      setError(null);
