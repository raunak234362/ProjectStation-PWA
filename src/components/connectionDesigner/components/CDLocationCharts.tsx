...
interface CDLocationChartsProps {
    growthData: { name: string; count: number }[]; // Monthly growth trend
    stateData: { name: string; count: number }[]; // State distribution
}

const CDLocationCharts: React.FC<CDLocationChartsProps> = ({ growthData, stateData }) => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="lg:col-span-2 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                <div className="flex items-center justify-between mb-6">
                    <div>
                        <h3 className="text-lg font-bold text-gray-800">Network Growth Velocity</h3>
                        <p className="text-xs text-gray-400 mt-1">New Connection Designers onboarded over time</p>
                    </div>
                </div>
            ...
            <div className="lg:col-span-1 bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col">
                <h3 className="text-lg font-bold text-gray-800 mb-6">State-wise Presence</h3>
