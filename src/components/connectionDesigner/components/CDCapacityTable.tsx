...
interface CDCapacityTableProps {
  recentActivity: DesignerActivity[];
}

const CDCapacityTable: React.FC<CDCapacityTableProps> = ({
  recentActivity,
}) => {
  return (
    <div className="mb-8">
      {/* Recently Active Designers */}
      <div className="bg-green-50 p-4 sm:p-6 rounded-2xl shadow-sm border border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          {recentActivity.length === 0 && (
            <p className="text-center text-sm text-gray-400 py-4 col-span-4">
              No recent activity
            </p>
          )}
        </div>
