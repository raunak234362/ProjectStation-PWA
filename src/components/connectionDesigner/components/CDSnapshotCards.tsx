    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
            {cards.map((card, index) => (
                <div key={index} className="bg-green-50 p-4 sm:p-5 rounded-md shadow-sm border border-gray-100 flex items-center justify-between relative overflow-hidden group">
                    ...
                    <div className={`p-2.5 sm:p-3 rounded-sm sm:rounded-md bg-${card.color}-50 text-${card.color}-600 shrink-0`}>
