...
const BfaVersionRow: React.FC<BfaVersionRowProps> = ({ version, index, total, isCurrent, bfaId }) => {
...
interface BfaManagerProps {
  submittalId: string;
}

const BfaManager: React.FC<BfaManagerProps> = ({ submittalId }) => {
        ...
        <div className="space-y-6">
          ...
          {hasMultipleVersions && (
            <div className="space-y-3 pt-4 border-t border-gray-200">
              ...
              <div className="space-y-2">
                {sortedVersions.map((version: any, index: number) => (
                  <BfaVersionRow
