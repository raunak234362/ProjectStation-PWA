...
const EditRFQByID = ({ id, onSuccess, onCancel }: EditRFQByIDProps) => {
    ...
    const onSubmit = async (data: EditRFQFormValues) => {
        try {
            const payload: any = {
                ...data,
                                ...
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        <ReactSelect
                                            ...
                                            onChange={(val: any) => field.onChange(val ? val.value : 'OPEN')}
                                            styles={selectStyles}
                                            menuPortalTarget={document.body}
