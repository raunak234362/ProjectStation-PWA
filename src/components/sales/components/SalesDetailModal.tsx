...
import { Files, Search, FileText, DollarSign, Users } from "lucide-react";
      ...
      case "RFQS":
        return [
          ...
          },
          {
            ...
            header: "RFQ #",
            cell: ({ row }) =>
              row.original.rfqNumber || row.original.projectNumber || "—",
          },
          {
            accessorKey: "status",
            header: "Status",
          ...
          },
          {
            ...
            cell: ({ row }) =>
              row.original.bidPrice
                ? `$${parseFloat(row.original.bidPrice).toLocaleString()}`
                : "—",
          },
          {
      ...
      case "INVOICES":
        return [
          ...
          },
          {
            ...
            cell: ({ row }) => {
              const amount = parseFloat(
                row.original.totalAmount || row.original.amount || 0,
              );
          ...
          },
          {
            ...
            cell: ({ row }) => (
              <span
                className={`px-3 py-1 text-xs uppercase font-bold rounded-lg border ${
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm font-medium">
                {data.length} total entries found
              </p>
            </div>
          </div>
          <button
