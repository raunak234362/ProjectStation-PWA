...
const AddAccount = ({ onSuccess }: AddAccountProps) => {
  const {
    register,
    handleSubmit,
    reset,
  ...
  return (
    <div className="bg-white p-6 md:p-8 rounded-xl shadow-2xl w-full mx-auto">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Button
          type="submit"
          className="mt-8 bg-green-50 border border-black hover:bg-green-200 text-black w-full py-3 text-lg  shadow-lg transition"
        >
