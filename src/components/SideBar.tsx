                ...
                <div key={label} className="relative group">
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      ...
                      ${isActive
                        ? "bg-gray-50 text-black border border-black/10 border-l-4 border-l-[#6bbd45]"
                        : "text-black hover:bg-gray-50 hover:text-black hover:border-y hover:border-r hover:border-black/10 hover:border-l-4 hover:border-l-[#6bbd45] border border-transparent border-l-4 border-l-transparent"
