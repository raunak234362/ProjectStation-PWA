    ...
    <div className="space-y-3">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-bold uppercase tracking-wider text-black">2. Project Schedule / Milestones</h3>
        </div>
        {canEdit && (
          <button
            onClick={onAddRow}
        ...
        <table className="w-full text-left border-collapse min-w-[800px] text-xs">
          ...
          <tbody className="">
            {scheduleRows.flatMap((row) => {
              ...
              if (hasEntries) {
                return row.unifiedEntries.map((entry: any, index: number) => {
