      ...
      <div className="bg-white w-full max-w-3xl rounded-[32px] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="rounded-2xl border border-gray-200 overflow-hidden focus-within:ring-4 focus-within:ring-green-500/10 focus-within:border-green-500/30 transition-all">
              <RichTextEditor
                value={message}
                onChange={setMessage}
