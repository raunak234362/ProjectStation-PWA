...
interface NoteResponseDetailsModalProps {
  noteId: string;
  response: any;
  onClose: () => void;
  onSuccess: () => void;
...
const NoteResponseDetailsModal: React.FC<NoteResponseDetailsModalProps> = ({
  noteId,
  response,
  onClose,
  onSuccess,
      ...
      <div className="ml-4 border-l-2 border-[#6bbd45]/20 pl-4 space-y-4 mt-4">
        {res.childResponses?.map((child: any) => (
          ...
          >
            ...
            <div
              className="text-sm text-gray-700 font-medium rich-text-content"
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar space-y-6 pr-2">
          <div className="bg-gray-50/50 p-6 rounded-2xl border border-gray-100 shadow-sm space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div
                className="text-gray-800 bg-white p-4 rounded-xl border border-gray-100 shadow-inner font-medium rich-text-content"
          ...
          {response.childResponses?.length > 0 && (
            <div className="space-y-4 pt-4">
              <h3 className="text-lg font-black text-black uppercase tracking-tight border-b border-[#6bbd45]/20 pb-2 flex items-center gap-2">
                Replies{" "}
                <span className="text-xs bg-[#6bbd45]/10 text-[#6bbd45] px-2 py-0.5 rounded-full">
                  {response.childResponses.length}
                </span>
              </h3>
