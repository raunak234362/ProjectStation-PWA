    ...
    <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="flex flex-col items-center p-3 rounded-xl hover:bg-gray-50 transition-colors cursor-pointer group text-center">
          ...
          <span className="text-xs font-bold text-gray-700">Pending RFI</span>
        ...
        <div className="flex flex-col items-center p-3 rounded-xl hover:bg-gray-50 transition-colors cursor-pointer group text-center">
          ...
          <span className="text-xs font-bold text-gray-700">Change Orders</span>
        ...
        <div className="flex flex-col items-center p-3 rounded-xl hover:bg-gray-50 transition-colors cursor-pointer group text-center">
          ...
          <span className="text-xs font-bold text-gray-700">Pending RFQ</span>
